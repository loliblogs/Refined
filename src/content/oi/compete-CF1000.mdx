...
<PostLink id="solution-CF1000A.mdx" collection="oi" text="A题代码" />
...
<PostLink id="solution-CF1000B.mdx" collection="oi" text="B题代码" />
...
<PostLink id="solution-CF1000C.mdx" collection="oi" text="C题代码" />
...
<PostLink id="solution-CF1000D.mdx" collection="oi" text="D题代码" />
...
<PostLink id="solution-CF1000E.mdx" collection="oi" text="E题代码" />
...
<PostLink id="solution-CF1000F.mdx" collection="oi" text="F题代码" />
...
<PostLink id="solution-CF1000G.mdx" collection="oi" text="G题代码" />
