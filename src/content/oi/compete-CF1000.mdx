...
<a href={getPostUrl('solution-CF1000A', 'oi')}>A题代码</a>
...
<a href={getPostUrl('solution-CF1000B', 'oi')}>B题代码</a>
...
<a href={getPostUrl('solution-CF1000C', 'oi')}>C题代码</a>
...
<a href={getPostUrl('solution-CF1000D', 'oi')}>D题代码</a>
...
<a href={getPostUrl('solution-CF1000E', 'oi')}>E题代码</a>
...
<a href={getPostUrl('solution-CF1000F', 'oi')}>F题代码</a>
...
<a href={getPostUrl('solution-CF1000G', 'oi')}>G题代码</a>
