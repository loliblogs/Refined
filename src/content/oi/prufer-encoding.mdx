...
代码详见 <a href={getPostUrl('solution-code2425#code', 'oi')}>Code</a>

## 模板题

* <a href={getPostUrl('solution-code2503', 'oi')}>[HNOI2004]树的计数</a>
* <a href={getPostUrl('solution-code1826', 'oi')}>小猴打架</a>
